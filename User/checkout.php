		      ...
		      <div class="row">
		        <div class="col-md-6 mb-5 mb-md-0">
		          ...
		          <div class="p-3 p-lg-5 border bg-white">
		            ...
		            <div class="form-group row">
		              <div class="col-md-12">
		                <label for="c_companyname" class="text-black">No. Telepon</label>
		                <input type="text" class="form-control" id="c_companyname" name="c_companyname">
		              </div>
		            </div>
		            ...
		            <div class="col-md-12">
		              ...
		              <div class="p-3 p-lg-5 border bg-white">
		                <table class="table site-block-order-table mb-5">
		                  ...
		                  <tbody>
		                    <tr>
		                      <td>Gas Elpiji 3Kg<strong class="mx-2">x</strong> 1</td>
		                      <td>Rp.20,000</td>
		                    </tr>
		                    <tr>
		                      <td>Aqua galon + Galon<strong class="mx-2">x</strong>   1</td>
		                      <td>Rp.60,000</td>
		                    </tr>
		                    <tr>
		                      <td class="text-black font-weight-bold"><strong>Cart Subtotal</strong></td>
		                      <td class="text-black">Rp.80,000</td>
		                    </tr>
		                    <tr>
		                      <td class="text-black font-weight-bold"><strong>Order Total</strong></td>
		                      <td class="text-black font-weight-bold"><strong>Rp.80,000</strong></td>
		                    </tr>
		                  </tbody>
		                </table>
		                <div class="border p-3 mb-5">
		                  <h3 class="h6 mb-0"><a class="d-block" data-bs-toggle="collapse" href="#collapsepaypal" role="button" aria-expanded="false" aria-controls="collapsepaypal">Dana : 089504732933</a></h3>
